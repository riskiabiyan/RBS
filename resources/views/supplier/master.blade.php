...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{asset('RBS1.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
      <span class="brand-text font-weight-light">RBS SUPPLIER</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{route('supplier.profil')}}" class="d-block">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('supplier.dashboard')}}" class="nav-link {{ request()->is('dashboard/supplier') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{ request()->is('supplier/data_pengiriman') ||  request()->is('supplier/pengiriman_kayu') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('supplier.pengiriman_kayu')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tambah Data Kayu</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('supplier.data_pengiriman')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Pengiriman</p>
                </a>
            </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="#">RBS</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
